...
function ReportForm({ metadataSubmit, metadataPopup, onButtonClick }) {

  return (
    <div className="im_detail fullscreen">
    <button type="button" className="close" id="closematadata2" onClick={() =>  onButtonClick(2)}><span aria-hidden="true">×</span></button>
