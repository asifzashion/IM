...
export const GET_SUBMITTALS = '/otcs/llisapi.dll/api/v1/nodes/116895788/output?format=webreport&draw=1&start=0&length=10';
export const GET_ASSIGNMENTS_NEW = '/otcs/llisapi.dll/api/v1/nodes/117635803/output?format=webreport&draw=1&start=0&length=10';
